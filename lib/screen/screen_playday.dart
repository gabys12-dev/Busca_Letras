...
void main() {
  runApp(const ScreenPlayday());
}

class ScreenPlayday extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    insertWord("FLUTTER", startRow: 1, startCol: 1, direction: "H"); // Horizontal
    insertWord("DART", startRow: 3, startCol: 2, direction: "V");    // Vertical
    insertWord("CODIGO", startRow: 5, startCol: 4, direction: "D");  // Diagonal
  }
