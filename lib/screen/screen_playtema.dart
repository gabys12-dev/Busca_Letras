...
void main() {
  runApp(const ScreenPlaytema());
}

class ScreenPlaytema extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    insertWord("PEDROI", startRow: 1, startCol: 1, direction: "H"); // Horizontal
    insertWord("NAPOLEAO", startRow: 3, startCol: 2, direction: "V");    // Vertical
    insertWord("GUERRA", startRow: 5, startCol: 4, direction: "D");  // Diagonal
  }
        ...
        child: Column(
          children: [
            ...
            Wrap(
              spacing: 10,
              children: const [
                Chip(label: Text("PEDROI")),
                Chip(label: Text("NAPOLEAO")),
                Chip(label: Text("GUERRA")),
              ],
            ),
          ],
        ),
