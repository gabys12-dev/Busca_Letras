...
void main() {
  runApp(const ScreenPlaytemp());
}

class ScreenPlaytemp extends StatelessWidget {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    insertWord("CADEIRA", startRow: 1, startCol: 1, direction: "H"); // Horizontal
    insertWord("BOLA", startRow: 3, startCol: 2, direction: "V");    // Vertical
    insertWord("TOMADA", startRow: 5, startCol: 4, direction: "D");  // Diagonal
  }
        ...
        child: Column(
          children: [
            ...
            Wrap(
              spacing: 10,
              children: const [
                Chip(label: Text("CADEIRA")),
                Chip(label: Text("BOLA")),
                Chip(label: Text("TOMADA")),
              ],
            ),
          ],
        ),
